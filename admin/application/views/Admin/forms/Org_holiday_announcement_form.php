...
<div class="modal-content" style="width: 100%;">
  <div class="modal-header modal-header-size">
    ...
    <h4 class="modal-title" id="customizedash">Announce Holiday Form</h4>
  </div>
  ...
  <div class="box-header with-border">
    <h3 class="box-title">Announce Holiday</h3>
  </div>
</div>
      ...
      <div class="box-body"> 
        <div class="row"> 
          <div class="col-sm-6 col-xs-6 ">
            <div class="">
              <label> Holiday Title <span class="error_message" style="color: #f00;">   </span></label>
              <input type="text" class="form-control" id="Title" name="Title" placeholder="Enter Holiday Title" value="<?php if(isset($edit_record_data)){ echo $edit_record_data['Title']; } ?>">
            </div>
          </div>
           <div class="col-sm-6 col-xs-6 ">
            <div class="">
              <label> Date <span class="error_message" style="color: #f00;">   </span></label>
              <input type="text" class="form-control datepicker" id="Date" name="Date" placeholder="Enter Holiday Date" value="<?php if(isset($edit_record_data)){ echo $edit_record_data['Date']; } ?>">
            </div>
          </div>
