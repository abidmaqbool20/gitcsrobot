...
<style type="text/css">
 ...
 <?php 
    ...
    if(isset($id) && $id != "")
    {
       $Event_Data = $this->db->get_where("announcements",array("Id"=>$id))->result_array();
       $edit_record_data = $Event_Data[0];
    }
...
<div class="modal-content" style="width: 100%;">
  <div class="modal-header modal-header-size">
    ...
    <h4 class="modal-title" id="customizedash">Add Event Form</h4>
  </div>
...
<form method="post" id="Org_Event_From" onsubmit="return save_Record(this)" action="<?php echo base_url('Admin/save_Record'); ?>" >
      ...
      <div class="box-body"> 
        <div class="row"> 
          <div class="col-sm-6 col-xs-6 ">
            <div class="">
              <label> Event Title <span class="error_message" style="color: #f00;">   </span></label>
              <input type="text" class="form-control" id="Title" name="Title" placeholder="Enter Event Title" value="<?php if(isset($edit_record_data)){ echo $edit_record_data['Title']; } ?>">
            </div>
          </div>
           <div class="col-sm-6 col-xs-6 ">
            <div class="">
              <label> Date <span class="error_message" style="color: #f00;">   </span></label>
              <input type="text" class="form-control datepicker" id="Date" name="Date" placeholder="Enter Event Date" value="<?php if(isset($edit_record_data)){ echo $edit_record_data['Date']; } ?>">
            </div>
          </div>
          <div class="col-sm-6 col-xs-6 ">
            <div class="">
          ...
          <div class="col-sm-12 col-xs-12 ">
            <div class="">
              <label>Event Description <span class="error_message" style="color: #f00;"> </span></label>
