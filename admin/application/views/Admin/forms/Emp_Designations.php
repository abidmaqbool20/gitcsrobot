...
<?php 
  ...
  if(isset($id) && $id != "")
  {
      $edit_info = $this->db->get_where("employee_designation",array("Id"=>$id,"Deleted"=>0));
      ...
      <div class="box-body">
        ...
        <div class="row">
          <div class="col-sm-6 col-xs-12 ">
            <div class="">
              <label> Designation Department<span class="error_message" style="color: #f00;">   </span></label>
              <select class="form-control select2" id="DesignationAdmin" name="DesignationAdmin" value="<?php if(isset($edit_record_data)){ echo $edit_record_data['DepId']; } ?>" >
                <?php 
                $department = $this->db->get_where("department",array("Deleted"=>0,"Status"=>1));
          ...
          <div class="col-sm-12 col-xs-12 ">
            <div class="">
              <label>Designation Name <span class="error_message" style="color: #f00;">   </span></label>
              <input type="text" class="form-control required" placeholder="Designation Name" name="DesignationTitle" id="DesignationTitle" value="<?php if(isset($edit_record_data)){ echo $edit_record_data['DesignationTitle']; } ?>" >
            </div>
          </div> 
        </div>
        <hr>
