   ...
   <section class="action_header_info h45 " >
      ...
      <div class="row" id="default">
        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12 padlft0" >
          <h3 style="margin-top: 0;">Activity Announcemetns</h3>
        </div>
        <div class="col-lg-7 col-md-7 col-sm-7 col-xs-12 pull-left padlft0" >
           <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3 pull-left padlft0">
                <div class="form-group padlft0">
                    <div class="form-group padlft0">
                      <select class="form-control select2" id="Activity_year" onchange="get_announcement('Activity');" > 
          ...
          <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3 pull-left padlft0">
                <div class="form-group padlft0">
                    <div class="form-group padlft0">
                      <select class="form-control select2" id="Activity_month"  onchange="get_announcement('Activity');" >
        ...
        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 " style="text-align: right;"   >
           <button class="btn btn-success pull-right btn-sm" data-target="#customizedash" data-controls-modal="#customizedash" data-backdrop="static" data-toggle="modal" data-keyboard="false" style="font-size: 15px;"  onclick="load_form(this,'Org_activity_announcement_form');"><i class="fa fa-plus"></i>&nbsp;Add Activity</button>
        </div> 
        ...
        <div class="tab-content tab-content-filter">
                ...
                <div class="col-md-12" style="margin-top: 30px; ">
                 ...
                 <?php   
                    ...
                    $activity_announcements = $this->db->get_where("announcements",array("Type"=>"Activity","Deleted"=>0)); 
                     
                    if($activity_announcements->num_rows() > 0)
                    {
                      foreach ($activity_announcements->result() as $key => $value) 
                      { 
                        $f_color = "";
                        $b_color = "info";
