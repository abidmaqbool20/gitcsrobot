          ...
          <div class="box-body">
            ...
            <div class="col-md-6">
              <div class="form-group">
                  ...
                  <input type="text" class="form-control clockpicker" value="<?php if(isset($org_Data['OpeningTime'])){ echo $org_Data['OpeningTime'];} ?>" id="OpeningTime" name="OpeningTime" placeholder="Enter Opening Time">
                </div>
            </div>
            <div class="col-md-6">
              <div class="form-group">
                  <label>Closing Time</label>
                  <input type="text" class="form-control clockpicker" value="<?php if(isset($org_Data['ClosingTime'])){ echo $org_Data['ClosingTime'];} ?>" id="ClosingTime" name="ClosingTime" placeholder="Enter Closing Time">
                </div>
            </div>
            <div class="col-md-6">
              <div class="form-group">
                  <label for="exampleInputEmail1">Break Start Time</label>
                  <input type="text" class="form-control clockpicker" value="<?php if(isset($org_Data['BreakStartTime'])){ echo $org_Data['BreakStartTime'];} ?>" id="BreakStartTime" name="BreakStartTime" placeholder="Enter Break Start Time">
                </div>
            </div>
            <div class="col-md-6">
              <div class="form-group">
                  <label for="exampleInputEmail1">Break End Time</label>
                  <input type="text" class="form-control clockpicker" value="<?php if(isset($org_Data['BreakEndTime'])){ echo $org_Data['BreakEndTime'];} ?>" id="BreakEndTime" name="BreakEndTime" placeholder="Enter Break End Time">
                </div>
            </div>
