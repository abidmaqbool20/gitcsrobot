...
<!-- Mirrored from adminlte.io/themes/AdminLTE/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 16 Dec 2017 15:08:01 GMT -->
...
<div class="wrapper">
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="<?php echo ASSETSPATH; ?>dist/img/user2-160x160.jpg" class="user-image" alt="User Image">
  ...
  <?php include("nav.php"); include("sidebar.php");  ?>