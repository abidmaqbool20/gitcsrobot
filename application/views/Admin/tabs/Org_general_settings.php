                ...
                <div class="col-md-12">
                     ...
                     <div class="form-group">
                        <div class=" ">
                          <label class="checkbox ML40 PT0I">
                            <input type="checkbox" name="EmailAlerts" value="1st" id="EmailAlerts" class="1" <?php if(isset($org_Data['EmailAlerts']) && $org_Data['EmailAlerts'] == 'on'){ echo "checked"; } ?> >
                  ...
                  <div class="col-md-4">
                     <div class="form-group">
                        <div class=" ">
                          <label  > 
                              <input class="checkbox-single" id="DesktopAlerts" <?php if(isset($org_Data['DesktopAlerts']) && $org_Data['DesktopAlerts'] == 'on'){ echo "checked"; } ?> name="DesktopAlerts" type="checkbox">
                              Desktop Alerts 
                          </label>
                        </div>
                     </div>
                  ...
                  <div class="col-md-4">
                     <div class="form-group">
                       <div class=" ">
                          <label  >
                            <input class="checkbox-single" id="SMSAlerts" <?php if(isset($org_Data['SMSAlerts']) && $org_Data['SMSAlerts'] == 'on'){ echo "checked"; } ?> name="SMSAlerts" type="checkbox">
                           SMS Alerts 
                          </label>
                       </div>
                     </div>
