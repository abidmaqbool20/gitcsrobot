           ...
           <div class="card">
            <ul class="nav nav-tabs" role="tablist">
                ...
                <li role="presentation">
                  <a href="#Yearly" aria-controls="Yearly" role="tab" data-toggle="tab">Yearly Attendence</a>
                </li> 
                
            </ul> 
            <div class="tab-content" style=" max-height:85.5vh !important; overflow-y: auto; overflow-x: hidden; padding-bottom: 150px;">
              
              <div role="tabpanel" class="tab-pane active" id="Dashboard" style="width:99%; ">
                <?php $this->load->view("Admin/forms/Employee_attendence_dashboard",$data); ?>
              </div>
              <div role="tabpanel" class="tab-pane" id="Monthly" style="width:99%; ">
                <?php $this->load->view("Admin/forms/Employee_monthly_attendence",$data); ?>
              </div>
              <div role="tabpanel" class="tab-pane" id="Yearly" style="width:99%; " >
                <?php $this->load->view("Admin/forms/Employee_yearly_attendence"); ?>
              </div>
