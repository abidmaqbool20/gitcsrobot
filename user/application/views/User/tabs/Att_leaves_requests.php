   <section class="action_header_info h45 " style="margin-top: -20px;">
      <div class="row" id="default">
        ...
        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 " style="text-align: right;"   >
           <button class="btn btn-success pull-right btn-sm" style="font-size: 15px;" data-target="#customizedash" data-controls-modal="#customizedash" data-backdrop="static" data-keyboard="false" onclick="load_form(this,'Emp_leave_form.php')" data-toggle="modal"><i class="fa fa-plus"></i>&nbsp;Apply For Leave</button>
        </div> 
